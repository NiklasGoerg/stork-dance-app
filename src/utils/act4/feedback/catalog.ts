...
type MetadataMap = Record<string, Act4CriterionFeedbackMetadata>;

const metadata = (
  category: Act4FeedbackCategory,
  priority: number,
  options: Omit<Act4CriterionFeedbackMetadata, "category" | "priority"> = {
    bodyRegion: null,
  },
): Act4CriterionFeedbackMetadata => ({
  category,
...
export const act4CommonFeedbackMetadata: MetadataMap = {
...
export const getAct4FeedbackMetadata = (season: ClimateSeason) => {
  if (season === "winter") {
    return {
...
export type Act4FeedbackCode =
  | AutumnFeedbackCode
  | SpringFeedbackCode
  | SummerFeedbackCode
  | WinterFeedbackCode;

export type Act4NarrationCueKey =
  | `story.acts.act4.narration.feedback.common.${string}`
  | `story.acts.act4.narration.feedback.winter.${string}`
  | `story.acts.act4.narration.feedback.spring.${string}`
  | `story.acts.act4.narration.feedback.summer.${string}`
  | `story.acts.act4.narration.feedback.autumn.${string}`;

const commonNarrationCues: Partial<
  Record<Act4FeedbackCode | string, Act4NarrationCueKey>
> = {
  ...
  TRY_AGAIN: "story.acts.act4.narration.feedback.common.tryAgain",
};

const winterNarrationCues: Partial<
  Record<WinterFeedbackCode, Act4NarrationCueKey>
> = {
  OPEN_ARMS_WIDER: "story.acts.act4.narration.feedback.winter.openArmsWider",
  RAISE_ARMS_TO_SHOULDERS:
    "story.acts.act4.narration.feedback.winter.raiseArmsToShoulders",
  STRAIGHTEN_ARMS_MORE:
    "story.acts.act4.narration.feedback.winter.straightenArmsMore",
  CROSS_ARMS_IN_FRONT:
    "story.acts.act4.narration.feedback.winter.crossArmsInFront",
  REACH_OPPOSITE_SHOULDERS:
    "story.acts.act4.narration.feedback.winter.reachOppositeShoulders",
  KEEP_ARMS_CROSSED:
    "story.acts.act4.narration.feedback.winter.keepArmsCrossed",
  STAY_UPRIGHT: "story.acts.act4.narration.feedback.winter.stayUpright",
  STAY_HIGHER: "story.acts.act4.narration.feedback.winter.stayHigher",
  CONTRACT_MORE: "story.acts.act4.narration.feedback.winter.contractMore",
  BEND_KNEES_MORE: "story.acts.act4.narration.feedback.winter.bendKneesMore",
  KEEP_BODY_COMPACT:
    "story.acts.act4.narration.feedback.winter.keepBodyCompact",
  PROTECT_HEAD: "story.acts.act4.narration.feedback.winter.protectHead",
  LOWER_BODY_AND_PROTECT_HEAD:
    "story.acts.act4.narration.feedback.winter.lowerBodyAndProtectHead",
  RETURN_TO_UPRIGHT:
    "story.acts.act4.narration.feedback.winter.returnToUpright",
  LOWER_ARMS: "story.acts.act4.narration.feedback.winter.lowerArms",
};

const springNarrationCues: Partial<
  Record<SpringFeedbackCode, Act4NarrationCueKey>
> = {
  START_HANDS_LOW: "story.acts.act4.narration.feedback.spring.startHandsLow",
  KEEP_HANDS_CLOSE_TO_BODY:
    "story.acts.act4.narration.feedback.spring.keepHandsCloseToBody",
  OPEN_ARMS_TO_BEGIN:
    "story.acts.act4.narration.feedback.spring.openArmsToBegin",
  OPEN_ARMS_HIGHER: "story.acts.act4.narration.feedback.spring.openArmsHigher",
  KEEP_BLOOM_LOWER: "story.acts.act4.narration.feedback.spring.keepBloomLower",
  REACH_ABOVE_HEAD: "story.acts.act4.narration.feedback.spring.reachAboveHead",
  GATHER_HANDS_IN_FRONT:
    "story.acts.act4.narration.feedback.spring.gatherHandsInFront",
  LOWER_AND_RETURN: "story.acts.act4.narration.feedback.spring.lowerAndReturn",
  LIFT_OTHER_KNEE: "story.acts.act4.narration.feedback.spring.liftOtherKnee",
  MATCH_BOTH_HANDS: "story.acts.act4.narration.feedback.spring.matchBothHands",
};

const summerNarrationCues: Partial<
  Record<SummerFeedbackCode, Act4NarrationCueKey>
> = {
  MOVE_HANDS_TO_CENTER:
    "story.acts.act4.narration.feedback.summer.moveHandsToCenter",
  RAISE_ARMS_HIGHER:
    "story.acts.act4.narration.feedback.summer.raiseArmsHigher",
  STRAIGHTEN_ARMS: "story.acts.act4.narration.feedback.summer.straightenArms",
  STEP_WIDER: "story.acts.act4.narration.feedback.summer.stepWider",
  STEP_SMALLER: "story.acts.act4.narration.feedback.summer.stepSmaller",
  ALTERNATE_STEP_SIDE:
    "story.acts.act4.narration.feedback.summer.alternateStepSide",
  OPEN_ARMS_TO_SIDES:
    "story.acts.act4.narration.feedback.summer.openArmsToSides",
  OPEN_ARMS_LESS: "story.acts.act4.narration.feedback.summer.openArmsLess",
  MOVEMENT_TOO_LARGE:
    "story.acts.act4.narration.feedback.summer.movementTooLarge",
  MOVEMENT_TOO_SMALL:
    "story.acts.act4.narration.feedback.summer.movementTooSmall",
  BEND_ELBOWS_MORE: "story.acts.act4.narration.feedback.summer.bendElbowsMore",
  RETURN_FEET_TO_CENTER:
    "story.acts.act4.narration.feedback.summer.returnFeetToCenter",
  LOWER_ARMS: "story.acts.act4.narration.feedback.summer.lowerArms",
};

const autumnNarrationCues: Partial<
  Record<AutumnFeedbackCode, Act4NarrationCueKey>
> = {
  START_LEFT: "story.acts.act4.narration.feedback.autumn.startLeft",
  START_RIGHT: "story.acts.act4.narration.feedback.autumn.startRight",
  WRONG_SWEEP_DIRECTION:
    "story.acts.act4.narration.feedback.autumn.wrongSweepDirection",
  SWEEP_LEFT: "story.acts.act4.narration.feedback.autumn.sweepLeft",
  SWEEP_RIGHT: "story.acts.act4.narration.feedback.autumn.sweepRight",
  ...
  ENDPOINT_TOO_FAR: "story.acts.act4.narration.feedback.autumn.endpointTooFar",
  ENDPOINT_REACHED_TOO_LATE:
    "story.acts.act4.narration.feedback.autumn.endpointReachedTooLate",
  ENDPOINT_UNSTABLE:
    "story.acts.act4.narration.feedback.autumn.endpointUnstable",
  END_AT_DESTINATION_SIDE:
    "story.acts.act4.narration.feedback.autumn.endAtDestinationSide",
  END_AT_FAR_DESTINATION_SIDE:
    "story.acts.act4.narration.feedback.autumn.endAtFarDestinationSide",
  END_AT_CENTER: "story.acts.act4.narration.feedback.autumn.endAtCenter",
  END_BEFORE_CENTER:
    "story.acts.act4.narration.feedback.autumn.endBeforeCenter",
  END_AT_START_SIDE_DIAGONAL:
    "story.acts.act4.narration.feedback.autumn.endAtStartSideDiagonal",
  ALIGN_BOTH_ARMS: "story.acts.act4.narration.feedback.autumn.alignBothArms",
  EXTEND_OUTER_ARM: "story.acts.act4.narration.feedback.autumn.extendOuterArm",
  KEEP_HANDS_AT_CHEST_HEIGHT:
    "story.acts.act4.narration.feedback.autumn.keepHandsAtChestHeight",
  KEEP_CHEST_FORWARD:
    "story.acts.act4.narration.feedback.autumn.keepChestForward",
  RETURN_HANDS_TO_CENTER:
    "story.acts.act4.narration.feedback.autumn.returnHandsToCenter",
  RETURN_FEET_TOGETHER:
    "story.acts.act4.narration.feedback.autumn.returnFeetTogether",
  START_ON_LEFT: "story.acts.act4.narration.feedback.autumn.startLeft",
  START_ON_RIGHT: "story.acts.act4.narration.feedback.autumn.startRight",
  MOVE_HANDS_TOGETHER:
    "story.acts.act4.narration.feedback.autumn.alignBothArms",
  KEEP_HANDS_CHEST_HEIGHT:
    "story.acts.act4.narration.feedback.autumn.keepHandsAtChestHeight",
  SWEEP_FARTHER:
    "story.acts.act4.narration.feedback.autumn.insufficientProgress",
  SWEEP_LESS: "story.acts.act4.narration.feedback.autumn.endpointTooFar",
};

export const getAct4FeedbackTextKey = (
  season: ClimateSeason,
  feedbackCode: string | null | undefined,
) => `story.acts.act4.${season}Feedback.${feedbackCode ?? "TRY_AGAIN"}`;

export const resolveAct4FeedbackNarrationCue = (
  season: ClimateSeason,
  feedbackCode: Act4FeedbackCode | string | null | undefined,
): Act4NarrationCueKey | null => {
...
export const resolveAct4IntensityNarrationCue = resolveAct4FeedbackNarrationCue;
