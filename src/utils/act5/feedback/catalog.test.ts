...
import { resolveAct5FeedbackNarrationCue } from "~/utils/act5/feedback/catalog";

describe("resolveAct5FeedbackNarrationCue", () => {
  it.each([
    [
      "spring",
    ...
    [
      "summer",
      "TRY_AGAIN",
      "story.acts.act5.narration.feedback.common.tryAgain",
    ],
    [
      "winter",
      "CROSS_ARMS_IN_FRONT",
    ...
    [
      "spring",
      "KEEP_BLOOM_LOWER",
      "story.acts.act5.narration.feedback.spring.keepBloomLower",
    ],
    [
      "summer",
      "ALTERNATE_STEP_SIDE",
    ...
    [
      "autumn",
      "START_LEFT",
      "story.acts.act5.narration.feedback.autumn.startLeft",
    ],
    [
      "autumn",
      "ENDPOINT_TOO_SHORT",
    ...
    expect(resolveAct5FeedbackNarrationCue(season, feedbackCode)).toBe(
      expectedCueKey,
    );
  });
  ...
  it.each([
    ...
    expect(resolveAct5FeedbackNarrationCue(season, feedbackCode)).toBeNull();
  });
});
