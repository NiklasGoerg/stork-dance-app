import type {
  ...
  Act5FeedbackCriterionLike,
  Act5FeedbackSignal,
} from "~/types/act5";
import type { ClimateSeason } from "~/types/climate";

const trackingCodeForRegion = (bodyRegion: Act5BodyRegion) => {
...
export const getAct5SignalMetadata = <TCode extends string>(
...
export const buildAct5BeatFeedbackSignals = <TCode extends string>({
  season,
  beat,
  measureIndex,
  criteria,
...
}): Act5FeedbackSignal<TCode>[] => {
  const signals: Act5FeedbackSignal<TCode>[] = [];
