...
import Act5ClimateProgressChart from "~/components/act5/ClimateProgressChart.vue";
import Act5InfoCard from "~/components/act5/InfoCard.vue";
...
import { useAct5ChartModel } from "~/composables/act5/useAct5ChartModel";
import { useAct5InfoCardModel } from "~/composables/act5/useAct5InfoCardModel";
import { useAct5Recognition } from "~/composables/act5/useAct5Recognition";
import { useAct5SkeletonFeedback } from "~/composables/act5/useAct5SkeletonFeedback";
import { useAct5ViewModel } from "~/composables/act5/useAct5ViewModel";
...
const recognition = useAct5Recognition({
...
} = useAct5ViewModel({ playbackState, currentSeason });
const {
