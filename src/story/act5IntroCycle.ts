...
export const ACT5_MOVEMENT_TIMING_DEFAULTS: MovementPlaybackTiming = {
  sourceFps: 30,
  prerollMs: 1_000,
  loopStartMs: 1_000,
  loopEndMs: 9_000,
...
const createMovementConfig = (
  ...
  movementTiming: ACT5_MOVEMENT_TIMING_DEFAULTS,
  movementLoopDurationMs: 8_000,
  movementPrerollMs: ACT5_MOVEMENT_TIMING_DEFAULTS.prerollMs,
});

export const act5SeasonMovementConfig = {
  winter: {
...
export const resolveAct5SeasonMovementConfig = (
  season: ClimateSeason,
  movementIntensity: number,
): SeasonalCycleSeasonConfig | null => {
  const seasonConfig = act5SeasonMovementConfig[season] as Record<
    number,
